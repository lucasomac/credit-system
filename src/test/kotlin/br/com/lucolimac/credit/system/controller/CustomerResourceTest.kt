...
import br.com.lucolimac.credit.system.dto.request.CustomerDto
import br.com.lucolimac.credit.system.dto.request.CustomerUpdateDto
...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Macedo"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("75869594093"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("lucasomac@outloook.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua da ladeira, 123333"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "Lup",
        lastName: String = "Lupdate",
        income: BigDecimal = BigDecimal.valueOf(5000.0),
        zipCode: String = "45656",
        street: String = "Rua 33"
